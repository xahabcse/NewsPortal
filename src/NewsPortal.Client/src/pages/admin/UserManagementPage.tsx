        ...
        <>
            ...
            <div className="p-4 sm:p-6 md:p-8">
                <div>
                    ...
                    <div className="mb-6 sm:mb-8">
                        <div className="flex items-start justify-between gap-3">
                            <div className="min-w-0">
                                <h1 className="text-2xl md:text-3xl font-bold text-white mb-1 sm:mb-2">User Management</h1>
                                <p className="text-secondary text-xs sm:text-sm">Manage users, roles, and account status</p>
                            </div>
                            <button
                                onClick={() => openModal()}
                                className="shrink-0 px-3 sm:px-4 py-2 bg-accent text-white rounded-lg text-xs sm:text-sm font-semibold hover:bg-accent/80 transition-colors flex items-center gap-1.5 sm:gap-2 whitespace-nowrap"
                            >
                    ...
                    {/* Stats Cards — 2-col mobile, 4-col md+, accent border-left for hierarchy */}
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-6">
                        <div className="glass-morphism border border-glass-border border-l-4 border-l-accent rounded-xl p-3 sm:p-4">
                            <div className="text-xs sm:text-sm text-secondary mb-1">Total Users</div>
                            <div className="text-xl sm:text-2xl font-bold text-white">{users.length}</div>
                        </div>
                        <div className="glass-morphism border border-glass-border border-l-4 border-l-purple-500 rounded-xl p-3 sm:p-4">
                            <div className="text-xs sm:text-sm text-secondary mb-1">Super Admins</div>
                            <div className="text-xl sm:text-2xl font-bold text-purple-400">{superAdminCount}</div>
                        </div>
                        <div className="glass-morphism border border-glass-border border-l-4 border-l-red-500 rounded-xl p-3 sm:p-4">
                            <div className="text-xs sm:text-sm text-secondary mb-1">Admins</div>
                            <div className="text-xl sm:text-2xl font-bold text-red-400">{users.filter(u => u.role === 'Admin').length}</div>
                        </div>
                        <div className="glass-morphism border border-glass-border border-l-4 border-l-green-500 rounded-xl p-3 sm:p-4">
                            <div className="text-xs sm:text-sm text-secondary mb-1">Active Users</div>
                            <div className="text-xl sm:text-2xl font-bold text-green-400">{users.filter(u => u.isActive).length}</div>
                        </div>
                    </div>
                    ...
                    <div className="md:hidden space-y-3">
                        {loading ? (
                            <div className="glass-morphism border border-glass-border rounded-xl p-8 text-center text-secondary">
                            ...
                            <div key={user.id} className="glass-morphism border border-glass-border rounded-xl p-4 space-y-3">
                                ...
                                <div className="flex flex-wrap items-center gap-2 text-xs">
                                    <span className={`px-2.5 py-1 rounded-full font-medium border whitespace-nowrap ${getRoleBadgeClass(user.role)}`}>{user.role}</span>
                                    <span className={`px-2.5 py-1 rounded-full font-medium whitespace-nowrap ${user.isActive ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400'}`}>
                                        {user.isActive ? 'Active' : 'Inactive'}
                                    </span>
                                </div>
                                <div className="grid grid-cols-2 gap-2 text-xs text-secondary">
                                    <div>
                                        <div className="text-secondary/60 mb-0.5">Last login</div>
                                        <div className="text-white">{formatShortDate(user.lastLoginAt)}</div>
                                    </div>
                                    <div>
                                        <div className="text-secondary/60 mb-0.5">Created</div>
                                        <div className="text-white">{formatShortDate(user.createdAt)}</div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-2 pt-2 border-t border-glass-border">
                                    <button
                                        onClick={() => openPasswordModal(user.id)}
                                        className="flex-1 py-2 text-xs text-secondary hover:text-white hover:bg-white/10 rounded-lg transition-colors flex items-center justify-center gap-1.5"
                                    ...
                                    <button
                                        ...
                                        className="flex-1 py-2 text-xs text-blue-400 hover:bg-blue-500/10 rounded-lg transition-colors flex items-center justify-center gap-1.5"
                                    ...
                                    <button
                                        ...
                                        className="flex-1 py-2 text-xs text-red-400 hover:bg-red-500/10 rounded-lg transition-colors flex items-center justify-center gap-1.5"
