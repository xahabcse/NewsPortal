...
namespace NewsPortal.Repository.Migrations
{
    ...
    [Migration("20260305120000_AddBioAndAvatar")]
    partial class AddBioAndAvatar
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewsPortal.Core.Entities.ArticleReaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("article_reactions", (string)null);
                });

            modelBuilder.Entity("NewsPortal.Core.Entities.ArticleReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("article_reports", (string)null);
                });
            ...
            modelBuilder.Entity("NewsPortal.Core.Entities.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NewsPortal.Core.Entities.CommentVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NewsPortal.Core.Entities.UserBookmark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NewsPortal.Core.Entities.UserReadHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("user_read_history", (string)null);
                });

            modelBuilder.Entity("NewsPortal.Core.Entities.ArticleReaction", b =>
                {
                    b.HasOne("NewsPortal.Core.Entities.NewsArticle", "Article")
                        .WithMany()
                        .HasForeignKey("ArticleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NewsPortal.Core.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("NewsPortal.Core.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("NewsPortal.Core.Entities.Comment", "Parent")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("NewsPortal.Core.Entities.CommentVote", b =>
                {
                    b.HasOne("NewsPortal.Core.Entities.Comment", "Comment")
                        .WithMany()
